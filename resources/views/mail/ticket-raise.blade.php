            ...
            'email' =>$data['email'], -->
                        <tr>
                            <td class="wrapper"
                                ...
                                <p>Email Address: <b>{{ $mailData['ticket_id'] }}</b></p>
                                <p>Employee Id: <b>{{ $mailData['Employee_id'] }}</b></p>
                                <p>Ticket Reason: <b>{{ $mailData['reason'] }}</b></p>
                                                        ...
                                                        <tr>
                                                            <td style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #0867ec;"
                                                                valign="top" align="center" bgcolor="#0867ec"> <a
                                                                    href="{{ $mailData['url'] }}" target="_blank"
                                                                    style="border: solid 2px #0867ec; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #0867ec; border-color: #0867ec; color: #ffffff;">Clike
                                                                    Here to join
                                                                </a> </td>
                                                        </tr>
                                                    </tbody>
                    ...
                    <div class="footer" style="clear: both; padding-top: 24px; text-align: center; width: 100%;">
                        <img src="{{$mailData['home_url']}}/logo.png" style="width:150px;">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-block"
                                    ...
                                    <a href="#"
                                        style="text-decoration: underline; color: #9a9ea6; font-size: 16px; text-align: center;">Velozion
                                        Technologies Pvt Ltd,</a><br>

                                    <span class="apple-link"
                                        style="color: #9a9ea6; font-size: 16px; text-align: center;"> 5/1, 2nd Floor,
                                        Saraswathamma Complex, <br> TC Palya Main Road, Ramamurthy Nagar, <Br>Bangalore
                                        - 560016.</span>
